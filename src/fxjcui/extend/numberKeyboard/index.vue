...
*    }
* @example
<number-keyboard v-model="yourValue" :word.sync="yourWord" :tips="false"></number-keyboard>
    ...
    >
      ...
      <div class="custom-number-keyboard">
        <div class="custom-number-keyboard-bar" v-if="!content">
          ...
          <svg @click="$emit('input', false)" type="ios-arrow-down" size="30" xmlns="http://www.w3.org/2000/svg"
               width="30" height="30" viewBox="0 0 512 512" class="vux-x-icon vux-x-icon-ios-arrow-down">
        ...
        <div class="custom-number-keyboard-content" @touchstart.stop.prevent="clickh">
          ...
          <div class="keyboard-content-warp">
            ...
            <div>6</div>
            <div>9</div>
            <div class="delete" :style="backgroundStyle">
              <i class="del"></i>
            </div>
          </div>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        backgroundUrl:require('./images/keyBoardDel.png'),
        key: ''
      }
    },
    directives: {
