...
<!-- @event blur 失去焦点返回-->
<template>
  <div class="vInputStyle" ref="vinput" :class="[textAlign]" tabindex="1" @click.stop="onclick" @focus="onfocus" @blur="onblur">
    <div v-if="!value && value !== 0" class="placeholder">{{placeholder}}</div>
    ...
    <span class="startLight" v-if="value !== 0 && !value && !blur"></span>
    <!-- <input ref="hiddenInput" class="hiddenInput" :disabled="readOnly" readonly @click="onclick" @focus="onfocus" @blur="onblur"> -->
  </div>
</template>
